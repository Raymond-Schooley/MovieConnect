        ...
        <div class="panel panel-default">
          ...
          <div class="text-center">
            ...
            <h3>Select quiz difficulty</h3>
        		    ...
        		    <input type="text" placeholder="Enter a percentage" name="difficulty" class="row"/>
                <input type="text" placeholder="Enter a year range" name="lowYear" class="row"/>
                <input type="text" placeholder="Enter a year range" name="highYear" class="row"/>
